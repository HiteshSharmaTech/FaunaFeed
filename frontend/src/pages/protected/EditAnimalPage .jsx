...
export default function AnimalForm({ post }) {
  ...
  const deletePostHandler = async () => {
    ...
    try {
      ...
      console.error("Deleting the post is failed");
    } finally {
      setIsDeleting(false);
    }
  };
        ...
        <div className="mb-8 flex justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Fill in the details to edit the post in the database
            </p>
          </div>
          <button
            onClick={deletePostHandler}
            className="bg-red-500 text-white rounded h-8 w-30 mt-5"
          >
            Delete Post
          </button>
        </div>
        <form onSubmit={handleSubmit(submitHandler)}>
          ...
          {submitSuccess && (
            <div className="mt-6 p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg">
              ...
              <p>
                The post has been updated in the database. The form will reset
                automatically.
              </p>
            </div>
          )}
